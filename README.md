...
The crate also provides the [`zalgo_embed!`](https://docs.rs/zalgo-codec-macro/latest/zalgo_codec_macro/macro.zalgo_embed.html/) macro that can be used to decode a string of encoded source code and pass the results on to the compiler. Imagine the code clarity!
